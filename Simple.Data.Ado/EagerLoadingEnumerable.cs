...
namespace Simple.Data.Ado
{
    public class EagerLoadingEnumerable : IEnumerable<IDictionary<string, object>>
    {
        ...
        {
            Dictionary<IDictionary<string, object>, IDictionary<string, WithContainer>> load = BuildLoadDictionary();
            ...
            foreach (var kvp in load)
            {
                ...
                {
                    index =
                        kvp.Key.Keys.Select((k, i) => new KeyValuePair<string, int>(k, i)).ToDictionary(
                            HomogenizedEqualityComparer.DefaultInstance);
                }
        ...
        private IEnumerable<Tuple<string, Dictionary<string, object>>> ExtractSingleObjects(
        ...
        private IEnumerable<Tuple<string, Dictionary<string, object>>> ExtractCollectionObjects(
            IDictionary<string, object> source)
        {
            List<string> names =
        ...
        #region Nested type: WithContainer
        ...
        private class WithContainer
        {
            ...
            public void AddToCollection(IDictionary<string, object> row)
            {
                ...
                if (Collection == null)
                    Collection = new HashSet<IDictionary<string, object>>(new DictionaryEqualityComparer());
                Collection.Add(row);
            }
