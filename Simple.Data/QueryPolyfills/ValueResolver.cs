...
{
    internal abstract class ValueResolver
    {
        ...
        public abstract void CopyValue(IDictionary<string, object> source, IDictionary<string, object> target,
                                       IEnumerable<IDictionary<string, object>> sourceAggregationValues = null);

        public abstract object GetValue(IDictionary<string, object> source,
                                        IEnumerable<IDictionary<string, object>> sourceAggregationValues = null);
    }
}