...
namespace Simple.Data
{
    internal static class MethodNameParser
    {
        internal static IDictionary<string, object> ParseFromBinder(InvokeMemberBinder binder, IList<object> args)
        {
            ...
            if (binder.Name.Equals("findby", StringComparison.OrdinalIgnoreCase) ||
                binder.Name.Equals("find_by", StringComparison.OrdinalIgnoreCase))
            {
                if (args.Count == 1)
                {
        ...
        internal static IDictionary<string, object> ParseFromMethodName(string methodName, IList<object> args)
        {
            ...
            IList<string> columns = GetColumns(RemoveCommandPart(methodName));
        ...
        internal static IDictionary<string, object> ParseFromMethodName(string methodName,
        ...
        {
            string[] columns = methodName.Split(new[] {"And"}, StringSplitOptions.RemoveEmptyEntries);
            return columns;
        }
    }
}